...
check(nav.includes('/agents", label: "Assistente IA", roles: ["visitante"'), "visitante não vê Assistente IA no menu do console.");
check(nav.includes('/biblioteca", label: "Biblioteca", roles: ["visitante"'), "visitante não vê biblioteca no menu do console.");
check(nav.includes('/seguranca", label: "Privacidade e LGPD", roles: ["visitante"'), "visitante não vê segurança no menu do console.");
