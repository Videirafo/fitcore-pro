...
export const FITCORE_NAV_ITEMS = Object.freeze([
  ...
  { id: "athlete_360", label: "Athlete 360", href: "/atleta", roles: ["gestor", "professor", "aluno"], section: "operação" },
  ...
  { id: "evidence_coach", label: "Coach", href: "/coach", roles: ["gestor", "professor", "aluno"], section: "inteligência" },
