...
export function FitCoreHeaderActionsClient() {
  ...
  return <div className="header-actions"><Link href="/agents">IA & Agents</Link><Link href="/setup">Setup</Link><Link className="primary-pill topbar-cta" href="/evolucao">Dashboard</Link></div>;
}
