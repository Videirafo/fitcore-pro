...
export function LoginPanel() {
  ...
  return <div className="two-col"><form className="panel" onSubmit={submit}><span className="label">Acesso</span><h2>Entrar com senha ou código</h2><label>Unidade<input name="tenant_slug" placeholder="slug da unidade" /></label><label>Identificador<input name="identifier" required placeholder="usuario ou código" /></label><label>Senha/código<input name="secret" required type="password" /></label><button type="submit">Entrar</button><button className="secondary" type="button" onClick={logout}>Sair</button></form><SessionCard /><JsonBlock data={out} /></div>;
}
