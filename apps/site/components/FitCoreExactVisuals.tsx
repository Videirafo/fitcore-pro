...
const sidebar = [["Visão geral", "home", "/dashboard"], ["Agenda", "calendar", "/agenda"], ["IA & Agents", "spark", "/agents"], ["Onboarding", "spark", "/onboarding"], ["Equipe", "users", "/equipe"], ["Professores", "users", "/equipe"], ["Alunos", "users", "/alunos"], ["Biblioteca de exercícios", "grid", "/biblioteca"], ["Treinos", "dumbbell", "/treinos"], ["Prescrição", "clipboard", "/treinos"], ["Execução", "play", "/execucao"], ["Evolução", "chart", "/evolucao"], ["Financeiro", "wallet", "/financeiro"], ["Relatórios", "chart", "/relatorios"], ["Auditoria", "shield", "/auditoria"], ["Segurança & LGPD", "shield", "/seguranca"], ["Configurações", "gear", "/configuracoes"]] as const;
